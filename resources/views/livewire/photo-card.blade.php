<div class="relative">
	...
	<button type="button" class="absolute top-0 right-0 p-1 bg-red-500 text-white rounded-full hover:bg-red-600 focus:outline-none" wire:click="removeImage()">
	...
	@else
	<div class="relative w-full h-40 rounded-lg border-2 border-dashed border-neutral-600 flex items-center justify-center">
		<input type="file" name="image" class="absolute inset-0 opacity-0" wire:model="image">
