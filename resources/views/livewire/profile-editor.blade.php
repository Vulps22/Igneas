...
<form action="{{ route('profile.save') }}" method="POST">
	...
	<div class="flex justify-center">
		...
		<div class="md:w-1/2">
			...
			<div class="rounded-lg max-md:border-0 md:border-2 border-neutral-800 p-10 mb-5">
				<h2 class="text-lg font-bold mb-5">Profile Images</h2>

				<!-- Profile image uploader -->
				<div class="grid grid-cols-3 gap-4 mt-5">
					@for ($i = 0; $i
					< 6; $i++) <x-profile-editor-photo-card :position="$i" :url="$images[$i]" />
					@endfor
				</div>
			</div>

			<div class="md:rounded-lg md:border-2 border-neutral-800 max-md:pl-5 p-10">
				<!-- UserProfile fields -->
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="bio">Bio:</label>
					<textarea class="max-md:col-span-4 md:col-span-5 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white col-span-5 px-2 py-2" name="bio" value="{{$profile->bio}}"></textarea>
				</div>
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="height" class="mr-2 max-md:col-span-2">Height:</label>
					<div class="max-md:col-span-4 md:col-span-5 flex">
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="weight">Weight:</label>
					<div class="max-md:col-span-4 md:col-span-5 flex">
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 col-span-2" for="body_type">Body Type:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="body_type">
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="sexuality" class="max-md:col-span-2">Sexuality:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="sexuality">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="position">Position:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="position">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="dominance">Dominance:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="dominance">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="ethnicity">Ethnicity:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="ethnicity">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="relationship_status">Relationship Status:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="relationship_status">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="looking_for">Looking For:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="looking_for">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="gender">Gender:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="gender">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="pronouns">Pronouns:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="pronouns">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="show_location">Show Location:</label>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label class="mr-2 max-md:col-span-2" for="show_age">Show Age:</label>
			...
			<div class="md:rounded-lg md:border-2 border-neutral-800 max-md:p-5 md:p-10 mt-10">
				<!-- UserHealth fields -->
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="hiv_status" class="max-md:col-span-2">HIV Status:</label>
					<select class="max-md:col-span-4 md:col-span-5 mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" name="hiv_status">
						<option value="">Prefer Not To Say</option>
				...
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="last_STI_test" class="max-md:col-span-2">Last STI Test:</label>
					<input class="mt-1 max-md:col-span-4 md:col-span-5 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" type="date" name="last_STI_test" value="{{ $sexual_health->last_STI_test }}">
				</div>
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="on_prep" class="max-md:col-span-2">On PrEP:</label>
					<input class="mt-1 max-md:col-span-4 md:col-span-5 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" type="checkbox" name="on_prep" {{ $sexual_health->on_prep ? 'checked' : '' }}>
				</div>
				<div class="grid grid-cols-6 gap-2 pt-2">
					<label for="show_hiv_status" class="max-md:col-span-2">Show Status:</label>
					<input class="mt-1 max-md:col-span-4 md:col-span-5 block w-full rounded-md border-gray-300 shadow-sm bg-neutral-800 text-white px-2 py-2" type="checkbox" name="show_hiv_status" {{ $sexual_health->show_hiv_status ? 'checked' : '' }}>
				</div>
			</div>
